...
ActiveRecord::Schema.define(:version => 20150701205136) do
  ...
  add_index "publishes", ["dc_member_id"], :name => "index_publishes_on_dc_member_id"
  add_index "publishes", ["publication_id"], :name => "index_publishes_on_publication_id"
